            ...
            <nav class="vertical">
                <ul> 
                    ...
                    <li><a href="#"> <input type="submit" onclick="window.location.href = '#'" value="CADASTRO" id='func'> </a> <br/> 
                        <ul>
                            <li><a href="#"> <input type="submit" onclick="window.location.href = 'Servlet_Perfil'" value="CADASTRO DE FUNCIONARIO" id='func'> </a> </li><br/> 
                    ...
                    <li><a href="#"> <input type="submit" onclick="window.location.href = '#'" value="CONSULTAR DADOS" id='func'> </a> <br/>
                        <ul>       
                            ...
                            <form name ="forml" action="Servlet_Listar_Produto" method="post"> 
                                <li><a href="#"> <input type="submit" onclick="window.location.href = 'LISTAR'" value="CONSULTAR PRODUTOS" id='func'> </a> </li>
                            </form>
                            <form name ="forml" action="Servlet_Listar_Cat" method="post"> 
                                <li><a href="#"> <input type="submit" onclick="window.location.href = 'LISTAR'" value="CONSULTAR CATEGORIA" id='func'> </a> </li>
                            </form>
                            <form name ="forml" action="Servlet_Listar_Pedidos" method="post"> 
                                <li><a href="#"> <input type="submit" onclick="window.location.href = 'LISTAR'" value="CONSULTAR PEDIDOS" id='func'> </a> </li>
                            </form>
                        </ul>
