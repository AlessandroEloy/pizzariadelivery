                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Cadastrar Produtos</strong>
                        </div>
                        <div class="card-body">
                  <div class="card-body card-block">
				  
					<form action="Servlet_Produtos" method="post" onsubmit="return checkForm(this);" class="form-horizontal"> 
                         <%
                            Usuario usuarioLog = (Usuario) session.getAttribute("usuarioLog");
                           
                        %>
					   <div class="row form-group">
						<div class="col col-md-2"><label for="select" class=" form-control-label">Categoria</label></div>
							...
							<input type="hidden" name="disponivel" id="disponivel"  value="TRUE" >  
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" name="ingredientes" id="ingredientes" size="100" maxlength="100" class="form-control" required></div>
                          </div>
						   <div class="row form-group">
                            <div class="col col-md-2"><label for="hf-preco" class=" form-control-label">Preço</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="valor" name="valor" class="dinheiro form-control"   required></div>
                          </div>
