				...
				<div class="col-lg-8">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Confirmação de pedido</strong>
                        </div>
                        <div class="card-body">
                            <table class="table">
							<td><%
								...
								out.print("O número do seu pedido é "+ carrinho.getCod() +"<br>"+" Realizado com Sucesso!"+ "<br>"+ "<b>Valor total do pedido R$"+ carrinho.CalcTotal());
							%>
					 </td>
             
            <td><a href="Pedido.jsp" class="btn btn-danger">Inicio</a> </td>
