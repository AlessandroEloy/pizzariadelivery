                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Atualizar Categoria</strong>
                        </div>
                        <div class="card-body">
					 ...
					 <form action="Servlet_Atualizar_Categoria" method="post"> 
                        <input type="hidden" name="cod" value="${categoria.getCod()}"></td>
                          ...
                          <div class="row form-group">
                            <div class="col col-md-2"><label for="hf-nome" class=" form-control-label">Categoria</label></div>
                            <div class="col-12 col-md-9"><input type="text" name="categoria" value="${categoria.getCategoria()}" class="form-control"></div>
                          </div>
