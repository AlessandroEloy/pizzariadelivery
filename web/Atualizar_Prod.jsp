                ...
                <div class="col-lg-8">
                  ...
                  <div class="card-body card-block">
					 ...
					 <form action="Servlet_Atualizar_Prod" method="post"> 
                         <input type="hidden" name="cod" value="${produto.getCod()}">
					   <div class="row form-group">
						<div class="col col-md-2"><label for="cat" class=" form-control-label">Categoria</label></div>
                            <div class="col-12 col-md-9">
                              <input type="text" name="codcat" value="${produto.getCategoria().getCategoria()}"disabled class="form-control">
                            </div>
							  </div>
                          <div class="row form-group">
                            <div class="col col-md-2"><label for="hf-nome" class=" form-control-label">Nome</label></div>
                            <div class="col-12 col-md-9"><input type="text" name="nome" value="${produto.getNome()}" class="form-control"></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-md-2"><label for="hf-desc" class=" form-control-label">Descrição</label></div>
                            <div class="col-12 col-md-9"><input type="text" name="ingredientes" value="${produto.getIngredientes()}" class="form-control"></div>
                          </div>
						   <div class="row form-group">
                            <div class="col col-md-2"><label for="hf-preco" class=" form-control-label">Preço</label></div>
                            <div class="col-12 col-md-9"><input type="text" name="valor" value="${produto.getValor()}" class="dinheiro form-control"></div>
                          </div>
						  <div class="row form-group">
                            <div class="col col-md-2"><label for="hf-func" class=" form-control-label">Funcionário</label></div>
                            <div class="col-12 col-md-9"><input type="text" name="usuario" class="form-control" value="${produto.getUsuario().getLogin() }"disabled ></div>
                          </div>
