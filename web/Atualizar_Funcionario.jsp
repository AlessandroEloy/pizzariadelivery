<%-- 
    ...
    Created on : 08/06/2018, 00:55:44
    Author     : Carol
--%>
					   ...
					   <div class="row form-group">
						<div class="col col-md-2"><label for="select" class=" form-control-label">Função</label></div>
                            <div class="col-12 col-md-9">
								  <input type="text" name="funcao" value="${funcionario.getFuncao()}" class="form-control">
								</div>
								</div>
					  
                          <div class="row form-group">
                            <div class="col col-md-2"><label for="hf-nome" class=" form-control-label">Nome</label></div>
                            <div class="col-12 col-md-9"><input type="text" name="nome" value="${funcionario.getNome()}" class="form-control" ></div>
                          </div>
						   ...
						   <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" name="sexo" value="${funcionario.getSexo()}" class="form-control"></div>
						   </div>
						  
						  
						    <div class="row form-group">
                            <div class="col col-md-2"><label for="hf-nascimento" class=" form-control-label">Nascimento</label></div>
                            <div class="col-12 col-md-9"><input type="text" name="nascimento" value="${funcionario.getNascimento()}" class="form-control"></div>
                          </div>
						  
						   <div class="row form-group">
                            <div class="col col-md-2"><label for="hf-telefone" class=" form-control-label">Telefone</label></div>
                            <div class="col-12 col-md-9"><input type="text" name="telefone" value="${funcionario.getTelefone()}" class="form-control"></div>
                          </div>
						  
						  <div class="row form-group">
                            <div class="col col-md-2"><label for="hf-rg" class=" form-control-label">RG</label></div>
                            <div class="col-12 col-md-9"><input type="text" name="rg" value="${funcionario.getRg()}" class="form-control"></div>
                          </div>
						  
						   <div class="row form-group">
                            <div class="col col-md-2"><label for="hf-cpf" class=" form-control-label">CPF</label></div>
                            <div class="col-12 col-md-9"><input type="text" name="cpf" value="${funcionario.getCpf()}" class="form-control"></div>
                          </div>
